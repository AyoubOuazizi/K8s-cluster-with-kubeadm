...
ansible-playbook playbooks/deploy_stats_app.yaml || { echo "Ansible playbook { deploy_stats_app } failed"; exit 1; }
ansible-playbook playbooks/deploy_web_app.yaml || { echo "Ansible playbook { deploy_web_app } failed"; exit 1; }
